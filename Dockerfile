...
# DB init + Server
CMD ["sh", "-c", "python scripts/init_db.py && uvicorn backend.main:app --host 0.0.0.0 --port ${PORT} --log-level info"]# Whisper-Modell vorab downloaden (STT – caching im Image)
